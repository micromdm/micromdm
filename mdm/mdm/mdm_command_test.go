	...
	var tests = []struct {
...

		{
			...
			testFn: func(t *testing.T, parts endToEndParts) {
				...
				if parts.req.CommandUUID != parts.payload.CommandUUID {
					t.Error("CommandPayload.CommandUUID should be set to CommandRequest.CommandUUID")
				}
			},
		},
