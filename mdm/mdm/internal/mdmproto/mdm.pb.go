...
type Command_OsUpdateStatus struct {
	OsUpdateStatus *OSUpdateStatus `protobuf:"bytes,36,opt,name=os_update_status,json=osUpdateStatus,oneof"`
}
...
func (*Command_OsUpdateStatus) isCommand_Request()                  {}
...
func (m *Command) GetOsUpdateStatus() *OSUpdateStatus {
	if x, ok := m.GetRequest().(*Command_OsUpdateStatus); ok {
		return x.OsUpdateStatus
	}
	return nil
}
...
func _Command_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *Command_OsUpdateStatus:
		_ = b.EncodeVarint(36<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.OsUpdateStatus); err != nil {
			return err
		}
	case nil:
	default:
...
func _Command_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 35: // request.rotate_filevault_key
		...
		return true, err
	case 36: // request.os_update_status
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(OSUpdateStatus)
		err := b.DecodeMessage(msg)
		m.Request = &Command_OsUpdateStatus{msg}
		return true, err
	default:
		return false, nil
	}
...
func (m *OSUpdateStatus) Reset()                    { *m = OSUpdateStatus{} }
func (m *OSUpdateStatus) String() string            { return proto.CompactTextString(m) }
func (*OSUpdateStatus) ProtoMessage()               {}
func (*OSUpdateStatus) Descriptor() ([]byte, []int) { return fileDescriptorMdm, []int{60} }
...
func init() {
	...
	proto.RegisterType((*OSUpdateStatus)(nil), "mdmproto.OSUpdateStatus")
...
func (m *Command_OsUpdateStatus) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.OsUpdateStatus != nil {
		dAtA[i] = 0xa2
		i++
		dAtA[i] = 0x2
		i++
		i = encodeVarintMdm(dAtA, i, uint64(m.OsUpdateStatus.Size()))
		n37, err := m.OsUpdateStatus.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n37
...
func (m *Setting) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DeviceName != nil {
		...
		n41, err := m.DeviceName.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n41
	...
	if m.Hostname != nil {
		...
		n42, err := m.Hostname.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n42
	...
	if m.VoiceRoaming != nil {
		...
		n43, err := m.VoiceRoaming.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n43
	...
	if m.PersonalHotspot != nil {
		...
		n44, err := m.PersonalHotspot.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n44
	...
	if m.DataRoaming != nil {
		...
		n46, err := m.DataRoaming.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n46
	...
	if m.Bluetooth != nil {
		...
		n47, err := m.Bluetooth.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n47
	...
	if m.ApplicationAttributes != nil {
		...
		n48, err := m.ApplicationAttributes.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n48
	...
	if m.MdmOptions != nil {
		...
		n49, err := m.MdmOptions.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n49
	...
	if m.PasscodeLockGracePeriod != nil {
		...
		n50, err := m.PasscodeLockGracePeriod.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n50
	...
	if m.MaximumResidentUsers != nil {
		...
		n51, err := m.MaximumResidentUsers.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n51
	...
	if m.DiagnosticSubmission != nil {
		...
		n52, err := m.DiagnosticSubmission.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n52
	...
	if m.AppAnalytics != nil {
		...
		n53, err := m.AppAnalytics.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n53
...
func (m *ApplicationAttributesSetting) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ApplicationAttributes != nil {
		...
		i++
		i = encodeVarintMdm(dAtA, i, uint64(m.ApplicationAttributes.Size()))
		n54, err := m.ApplicationAttributes.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n54
...
func (m *MDMOptionsSetting) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.MdmOptions != nil {
		...
		i++
		i = encodeVarintMdm(dAtA, i, uint64(m.MdmOptions.Size()))
		n55, err := m.MdmOptions.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n55
...
func (m *RotateFileVaultKey) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.FilevaultUnlock != nil {
		...
		n56, err := m.FilevaultUnlock.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n56
...
func (m *OSUpdateStatus) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *OSUpdateStatus) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *Command_OsUpdateStatus) Size() (n int) {
	var l int
	_ = l
	if m.OsUpdateStatus != nil {
		l = m.OsUpdateStatus.Size()
		n += 2 + l + sovMdm(uint64(l))
	}
	return n
}
...
func (m *OSUpdateStatus) Size() (n int) {
	var l int
	_ = l
	return n
}
...
func (m *Command) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 36:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OsUpdateStatus", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Request = &Command_OsUpdateStatus{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipMdm(dAtA[iNdEx:])
...
func (m *OSUpdateStatus) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: OSUpdateStatus: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: OSUpdateStatus: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
var fileDescriptorMdm = []byte{
	...
	,
}
